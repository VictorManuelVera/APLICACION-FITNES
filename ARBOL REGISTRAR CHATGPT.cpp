...
int masculino = 0, femenino = 0, ninguno = 0, sumaGenero = 0;
...
void preorden(arbol *aux3) {
    if (aux3 != NULL) {
        ...
        cout<<"Hay un total de: "<<masculino<< " estudiantes de genero masculino"<<endl;
        cout<<"Hay un total de: "<<femenino<< " estudiantes de genero femenino"<<endl;
        cout<<"Hay un total de: "<<ninguno<< " estudiantes de genero raro"<<endl;
